...
Copilot can scan the entire repo and update references across multiple files. We have skills for:
...
- **update-default-org**: Update organization-specific settings
